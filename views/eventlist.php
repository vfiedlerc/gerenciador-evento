...
<div class="col-md-12">
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">Detalhes do diario de evento</h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
      <table class="table table-bordered">
        <tr>
          ...
          <th>Phone</th>
          <th>Booking Date</th>
          <th style="width: 140px">Numero da pessoa</th>
	  ...
	  foreach($records as $rec) {
        ...
        <tr>
		  ...
		  <td><?php if($status == "PENDING") {?>
            <a href="javascript:approve('<?php echo $user_id ?>');">Aprovar</a>&nbsp;/
			&nbsp;<a href="javascript:decline('<?php echo $user_id ?>');">Negar</a>&nbsp;/
			&nbsp;<a href="javascript:deleteUser('<?php echo $user_id ?>');">Deletar</a>
            <?php } else { ?>
			<a href="javascript:deleteUser('<?php echo $user_id ?>');">Deletar</a>
			<?php }//else ?>
          </td>
